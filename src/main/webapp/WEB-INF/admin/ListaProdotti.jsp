    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            <%@ include file="../results/header.jsp" %>
                        ...
                        <%@ include file="admin_nav.jsp" %>
                            ...
                            <div class="admin-filters">
                                <div class="admin-search">
                                    <input type="text" id="query2" placeholder="Cerca prodotti..."
                                        class="admin-search-input">
                                    <button onclick="filterProducts(document.getElementById('query2').value)"
                ...
                <script>
                    document.getElementById('query2').addEventListener('keypress', function (event) {
                        if (event.key === 'Enter') {
