    ...
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <head>
                ...
                <title>DuckDuckStore | Admin - Modifica Prodotto</title>
                <!-- Core styles -->
                <link rel="stylesheet" href="${pageContext.request.contextPath}/css/design-system.css">
                <!-- Component-specific styles -->
                <link rel="stylesheet" href="${pageContext.request.contextPath}/css/header.css">
                <link rel="stylesheet" href="${pageContext.request.contextPath}/css/footer.css">
                <link rel="stylesheet" href="${pageContext.request.contextPath}/css/modifica_prodotto.css">
                <!-- Fonts -->
                            ...
                            <div class="summary">
                                <div class="row">
                                    ...
                                    <div class="detail">
                                        ...
                                        <input type="number" placeholder="Prezzo &euro;" name="Prezzo" id="prezzo"
                                            step="0.01" value="${prodotto.prezzo}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="detail">
                                        ...
                                        <input type="number" min="1" max="99" placeholder="Quantita'" name="Quantita"
                                            id="quantita" value="${prodotto.quantita}" required>
                                    </div>
                                    <div class="detail">
                                        <label for="sconto">Sconto</label>
                                        <input type="number" min="0" max="100" placeholder="Sconto" name="Sconto"
                                            id="sconto" value="${prodotto.sconto}" required>
                                    </div>
                                    <div class="detail">
                                        ...
                                        <select placeholder="Categoria" name="Categoria" id="categoria" required>
                                            ...
                                            <option value="spaventose">spaventose</option>
                                ...
                                <div class="detail">
                                    ...
                                    <textarea cols="30" rows="5" placeholder="Descrizione" name="Descrizione"
                                        id="descrizione" required>${prodotto.descrizione}</textarea>
                                </div>
                                <div class="detail">
